<div x-data="{ open: false }" class="flex-shrink-0">
    ...
    <div :class="open ? 'translate-x-0' : '-translate-x-full md:translate-x-0'"
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            ...
            <x-nav-link :href="route('ai-insights.index')" :active="request()->routeIs('ai-insights.*')" class="w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group">
                <div class="p-1.5 rounded-lg bg-white/5 group-hover:bg-brand-500/20 group-[.active]:bg-brand-500/20 transition-colors">
                    <svg class="w-5 h-5 text-gray-500 group-hover:text-brand-400 group-[.active]:text-brand-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                </div>
                <span class="font-medium text-gray-500 group-hover:text-white group-[.active]:text-white">AI Insights</span>
            </x-nav-link>

            <x-nav-link :href="route('ai-trading.index')" :active="request()->routeIs('ai-trading.*')" class="w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group">
                <div class="p-1.5 rounded-lg bg-white/5 group-hover:bg-brand-500/20 group-[.active]:bg-brand-500/20 transition-colors">
